...
LABEL_DESCRIPTION="The Developmentimage for ROS2 Cuisine"
LABEL_VCS__URL="https://github.com/ros2cuisine/vsc-master-release"
LABEL_DOCKER_CMD="docker pull ros2cuisine/vsc-master"
